...
// inputs with no timing checks
  ...
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-119] REFCLK_FREQUENCY attribute is set to %f.  Legal values for this attribute are 200.0 to 2667.0. Instance: %m", MODULE_NAME, REFCLK_FREQUENCY_REG);
      attr_err = 1'b1;
    end
