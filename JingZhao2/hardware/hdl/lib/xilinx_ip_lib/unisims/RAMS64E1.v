...
`else
  ...
  assign I_in = I;
  assign WADR_in = {WADR8, WADR7, WADR6};
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge CLK, negedge WADR8, 0:0:0, 0:0:0, notifier,sh_we_clk_en_n,sh_we_clk_en_n, CLK_dly, WADR_dly[2]);
    ...
    $setuphold (negedge CLK, posedge WADR8, 0:0:0, 0:0:0, notifier,sh_we_clk_en_n,sh_we_clk_en_n, CLK_dly, WADR_dly[2]);
    ...
    $setuphold (posedge CLK, negedge WADR8, 0:0:0, 0:0:0, notifier,sh_we_clk_en_p,sh_we_clk_en_p, CLK_dly, WADR_dly[2]);
    ...
    $setuphold (posedge CLK, posedge WADR8, 0:0:0, 0:0:0, notifier,sh_we_clk_en_p,sh_we_clk_en_p, CLK_dly, WADR_dly[2]);
