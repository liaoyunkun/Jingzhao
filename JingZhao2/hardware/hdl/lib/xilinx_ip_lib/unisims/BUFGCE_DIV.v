...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $recrem ( negedge CLR, negedge I, 0:0:0, 0:0:0, notifier,sh_i_en_n,sh_i_en_n, CLR_delay, I_delay);
    $recrem ( negedge CLR, posedge I, 0:0:0, 0:0:0, notifier,sh_i_en_p,sh_i_en_p, CLR_delay, I_delay);
    $recrem ( posedge CLR, negedge I, 0:0:0, 0:0:0, notifier,sh_i_en_n,sh_i_en_n, CLR_delay, I_delay);
    $recrem ( posedge CLR, posedge I, 0:0:0, 0:0:0, notifier,sh_i_en_p,sh_i_en_p, CLR_delay, I_delay);
    $setuphold (negedge I, negedge CE, 0:0:0, 0:0:0, notifier,sh_i_en_n,sh_i_en_n, I_delay, CE_delay);
    $setuphold (negedge I, posedge CE, 0:0:0, 0:0:0, notifier,sh_i_en_n,sh_i_en_n, I_delay, CE_delay);
    $setuphold (posedge I, negedge CE, 0:0:0, 0:0:0, notifier,sh_i_en_p,sh_i_en_p, I_delay, CE_delay);
    $setuphold (posedge I, posedge CE, 0:0:0, 0:0:0, notifier,sh_i_en_p,sh_i_en_p, I_delay, CE_delay);
