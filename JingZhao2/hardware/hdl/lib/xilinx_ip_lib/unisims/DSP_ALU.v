...
`ifdef XIL_TIMING
  assign A_ALU_delay = A_ALU;
  assign B_ALU_delay = B_ALU;
  assign CARRYCASCIN_delay = CARRYCASCIN;
  assign CCOUT_delay = CCOUT;
  assign C_DATA_delay = C_DATA;
  assign MULTSIGNIN_delay = MULTSIGNIN;
  assign PCIN_delay = PCIN;
  assign P_FDBK_47_delay = P_FDBK_47;
  assign P_FDBK_delay = P_FDBK;
  assign U_DATA_delay = U_DATA;
  assign V_DATA_delay = V_DATA;
`endif
...
// CR 619940 -- Enhanced DRC warning
        ...
        if(!((MULTSIGNIN_in === 1'bx) || (cis_drc_msg == 1'b1) ||
             (OPMODEREG_BIN == OPMODEREG_1))) begin
