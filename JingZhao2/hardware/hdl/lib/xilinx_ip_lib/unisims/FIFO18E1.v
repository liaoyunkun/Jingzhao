...
//wrclk_in
    always @(almostfull_wire or rst_in or GSR) ALMOSTFULL = almostfull_wire;
    always @(full_wire or rst_in or GSR) FULL = full_wire;
    always @(wrerr_wire or rst_in or GSR) WRERR = wrerr_wire;
    always @(wrcount_wire or rst_in or GSR) WRCOUNT = wrcount_wire;

//rdclk_in
    always @(almostempty_wire or rst_in or GSR) ALMOSTEMPTY = almostempty_wire;
    always @(empty_wire or rst_in or GSR) EMPTY = empty_wire;
    always @(rderr_wire or rst_in or GSR) RDERR = rderr_wire;
    always @(rdcount_wire or rst_in or GSR) RDCOUNT = rdcount_wire;
    
    always @(do_wire or rst_in or GSR) DO = do_wire;
    always @(dop_wire or rst_in or GSR) DOP = dop_wire;
