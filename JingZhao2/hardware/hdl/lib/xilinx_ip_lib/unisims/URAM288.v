...
`else
  ...
  localparam  [11:0] NUM_UNIQUE_SELF_ADDR_A_REG = NUM_UNIQUE_SELF_ADDR_A;
  localparam  [11:0] NUM_UNIQUE_SELF_ADDR_B_REG = NUM_UNIQUE_SELF_ADDR_B;
  localparam  [11:0] NUM_URAM_IN_MATRIX_REG = NUM_URAM_IN_MATRIX;
...
`ifdef XIL_XECLIB
  ...
  assign NUM_UNIQUE_SELF_ADDR_A_BIN = NUM_UNIQUE_SELF_ADDR_A_REG;
  
  assign NUM_UNIQUE_SELF_ADDR_B_BIN = NUM_UNIQUE_SELF_ADDR_B_REG;
  
  assign NUM_URAM_IN_MATRIX_BIN = NUM_URAM_IN_MATRIX_REG;
...
`else
  ...
  NUM_UNIQUE_SELF_ADDR_A_BIN = NUM_UNIQUE_SELF_ADDR_A_REG;
  
  NUM_UNIQUE_SELF_ADDR_B_BIN = NUM_UNIQUE_SELF_ADDR_B_REG;
...
`endif
  ...
  always @ (*) begin
    if (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE) begin
      ram_ce_a_pre = &(~(ADDR_A_int[22:12] ^ SELF_ADDR_A_BIN) | SELF_MASK_A_BIN) && EN_A_int;
    end else begin
...
`endif
  ...
  always @ (*) begin
    if (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE) begin
      ram_ce_b_pre = &(~(ADDR_B_int[22:12] ^ SELF_ADDR_B_BIN) | SELF_MASK_B_BIN) && EN_B_int;
    end else begin
