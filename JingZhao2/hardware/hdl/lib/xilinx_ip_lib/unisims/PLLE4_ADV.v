...
`ifndef XIL_TIMING
  ...
  localparam real CLKIN_FREQ_MIN = 70.0;
  localparam real CLKPFD_FREQ_MAX = 667.5;
  localparam real CLKPFD_FREQ_MIN = 70.0;
  localparam real VCOCLK_FREQ_MAX = 1500.0;
  localparam real VCOCLK_FREQ_MIN = 750.0;
`endif
